...
if (isset($_POST['registrar'])){
  ...
  $RFC=$registrarCLIENTE->get_rfc();
  $NOMBRE=$registrarCLIENTE->get_nom();
  $CORREO=$registrarCLIENTE->get_email();
  $DOMICILIO=$registrarCLIENTE->get_domicilio();
  $TELEFONO=$registrarCLIENTE->get_tel();

  $PLACAS=$registrarAUTO ->get_placas();
  $MARCA=$registrarAUTO ->get_marca();
  $MODELO=$registrarAUTO ->get_modelo();
  $VERSION=$registrarAUTO ->get_version();
  $TIPO=$registrarAUTO ->get_tipo();
  $COLOR=$registrarAUTO ->get_color();
  $YEAR=$registrarAUTO ->get_year();
/*
  echo $Vnombre;
  echo $Vtelefono;
  echo $Vmascota;
...
*/
 ...
 $objeto_insertarCliente->INSERTAR();

 $objeto_insertarAUTO = new CLASE_AUTOMOVIL($PLACAS,$MARCA,$MODELO,$VERSION,$TIPO,YEAR,$COLOR);
 $objeto_insertarAUTO->INSERTAR();

}

if (isset($_POST['guardar'])){
  include ('../CLASES MODELO/modelo.php');
  $Vnombre=$objeto_iu11->get_caja_nombreH();
  $Vtelefono=$objeto_iu11->get_caja_telefono();
  $Vmascota=$objeto_iu11->get_caja_mascotas();
  $Vllegada=$objeto_iu11->get_caja_fechaentrada();
  $Vsalida=$objeto_iu11->get_caja_fechasalida();
